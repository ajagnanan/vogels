...
Table.prototype.tempCreate = function (item, options, callback) {
  var self = this;
  ...
  if (_.isArray(item)) {
    async.map(item, function (data, callback) {
      return internals.tempCreateItem(self, data, options, callback);
    }, callback);
  } else {
    return internals.tempCreateItem(self, item, options, callback);
  }
};
...
internals.tempCreateItem = function (table, item, options, callback) {
  var self = table;
